...
| `#总结 三天` | 查询三天内总结 | #总结 三天 |
| `#总结 七天` | 查询七天内总结 | #总结 七天 |
| `#强制总结` | [主人] 强制生成传统总结 | #强制总结 |
| `#群聊报告` | **[新]** 生成增强分析报告 | #群聊报告 |
| `#群聊报告 三天` | 生成三天增强报告 | #群聊报告 三天 |
| `#群聊报告 七天` | 生成七天增强报告 | #群聊报告 七天 |
| `#清除艾特数据` | 清除自己的艾特记录 | #清除艾特数据 |
| `#清除全部艾特数据` | [主人] 清除所有艾特记录 | #清除全部艾特数据 |

**功能区别**：
- `#总结` - 查询已保存的传统 AI 总结（由定时任务生成）
- `#强制总结` - [主人专用] 立即生成传统 AI 总结
- `#群聊报告` - [新功能] 生成增强分析报告（包含话题、金句、称号、活跃度图表等）
...
4. **增强分析报告 (新功能)**
   ```
   用户: #群聊报告
   机器人: 正在生成当天的增强分析报告，请稍候...
   机器人: [返回包含话题、金句、称号、活跃度图表的精美报告]
   ```

   支持多天分析：
   ```
   用户: #群聊报告 七天
   机器人: 正在生成七天的增强分析报告，请稍候...
   机器人: [返回七天的综合分析报告]
   ```
